render_server_pendanaan <- function(params) {
  ...
  output$analysisTextBantuanPerusahaan <- renderText({
    analysisTextBantuanPerusahaan <- "Masyarakat Desa mengharapkan bantuan dari perusahaan berupa bantuan sesuai dengan kebutuhan yang diajukan dalam proposal, santunan untuk anak yatim, serta pelatihan dan penyuluhan untuk meningkatkan wawasan dan sumber daya manusia (SDM)."
  ...
  output$analysisTextBantuanDesa <- renderText({
    analysisTextBantuanDesa <- "Masyarakat Desa mengharapkan bantuan dari Pemerintahan Desa berupa BLT setiap bulan, sembako, koperasi untuk modal usaha, pelatihan untuk menambah keterampilan, pembangunan infrastruktur, serta subsidi harga pupuk dan bibit."
